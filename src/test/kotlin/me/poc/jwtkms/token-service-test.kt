...
class TokenServiceTest {
    ...
    fun authenticateAndVerify() {
        ...
        //Verification
        var verifyResponse = tokenService.verify(VerifyTokenRequest(decodedJwt.token))
        ...
        verifyResponse = tokenService.verify(VerifyTokenRequest(invalidToken))
        assertEquals(HttpStatus.BAD_REQUEST, verifyResponse.statusCode)
    }
}